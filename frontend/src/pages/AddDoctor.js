...
function AddDoctor() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await API.post("/doctors/add", data);
      setMessage({ text: "Doctor successfully registered to HMS!", type: "success" });
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "50px" }}>
          ...
          <div style={{ width: "100%", maxWidth: "500px", display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
            <h2 style={{ color: "#00203f", margin: 0 }}>Onboard New Doctor</h2>
            <button 
          ...
          <div style={formCardStyle}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: "flex", gap: "15px" }}>
                <div style={{ flex: 1 }}>
                  <label style={labelStyle}>Consultation Fees (₹)</label>
                  <input 
                    required
                    type="number"
                    style={inputStyle}
